...
final class WindowState implements WindowManagerPolicy.WindowState {
    ...
    // Added by Franzi
    // If this window is in an embedded group, and the window manager
    // decides it should get focus, it should use realFocusedWin one instead
    // (set by checkRequestWindowFocus() in WindowManagerService)
    WindowState mRealFocusedWin;
    final WindowState mRealParentWindow;
    final IBinder mSelfToken; // to help id me as realParentWindow for future children
    ...
    WindowState(WindowManagerService service, Session s, IWindow c, WindowToken token, IBinder selfToken,
           WindowState attachedWindow, WindowState realParentWindow, int seq, WindowManager.LayoutParams a,
        ...
        if ((mAttrs.type >= FIRST_SUB_WINDOW &&
            ...
            mRealParentWindow = realParentWindow;
    ...
    void removeLocked() {
        ...
        if (mAttachedWindow != null) {
            ...
            if (mAttachedWindow.mRealFocusedWin == this) mAttachedWindow.mRealFocusedWin = null;
        }
