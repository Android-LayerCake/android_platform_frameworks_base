...
final class ActivityRecord {
    ...
    // Added by Franzi: keep track of embedded Activities for lifecycle fate sharing
    ArrayList<ActivityRecord> embeddedActivities; // parents will have this set
    // Added by Franzi: id for embedded activities to allow refresh
    int embeddedId; // children will have this set
    ActivityRecord parentActivity; // children will have this set
    ActivityRecord immediateParentActivity; // children will have this set
    										// (will be different from parentActivity only when multiple nesting)
    Bundle layoutParams; // children will have this set
    ...
    ActivityRecord(ActivityManagerService _service, ActivityStack _stack, ProcessRecord _caller,
        ...
        embeddedActivities = new ArrayList<ActivityRecord>(); // Added by Franzi
        embeddedId = 0; // Added by Franzi
