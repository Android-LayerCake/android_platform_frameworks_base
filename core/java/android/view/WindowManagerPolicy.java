...
public interface WindowManagerPolicy {
    ...
    public interface WindowManagerFuncs {
        ...
        /**
         * Added by Franzi.
         * Ask the WindowManager to focus this window.
         */
        public void checkRequestWindowFocus(WindowState win);
    }
    ...
    /**
     * Added by Franzi.
     * Called from the input dispatcher thread before a motion event is dispatched to a window.
     *
     * <p>This is for embedded activity groups: motion events 
     * on non-focused windows in the currently focused activity group
     * should cause the window manager to focus that window.
     * This method is called from the input thread, with no locks held.
     * 
     * @param win The window to which the motion
     *            event will normally go.
     *            (Not necessarily the in focus window)
