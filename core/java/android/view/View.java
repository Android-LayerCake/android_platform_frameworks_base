...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    protected static final boolean BENCHMARK_EMBEDDED = false;
    ...
    */
    ...
    /** Added by Franzi
     * (Using variable instead of a flag because I don't understand how all
     * the flags were assigned and I don't want to make a hard-to-find conflict.
     */
    private boolean mFilterTouchesWhenNotFullyVisible = false;
     ...
     * Added by Franzi
     * Sets whether the framework should discard touches when the view's
     * window didn't receive the minimum size required by the containing
     * Activity (for an embedded Activity), OR the embedded Activity's
     * window is currently clipped (or not visible).
     * @param enabled True if touch filtering should be enabled on not fully visible
     */
    public void setFilterTouchesWhenNotFullyVisible(boolean enabled) {
    	mFilterTouchesWhenNotFullyVisible = enabled;
    }
    ...
    */
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
    	if (BENCHMARK_EMBEDDED) {
    		Log.i("View", "Franzi's benchmarking time: dispatchTouchEvent eventTime : " 
    				+ event.getEventTime());
    		Log.i("View", "Franzi's benchmarking time: dispatchTouchEvent : " 
    ...
    public boolean onFilterTouchEventForSecurity(MotionEvent event) {
        ...
        // Added by Franzi: might also/instead drop if missized
        if (mFilterTouchesWhenNotFullyVisible && !fullyVisible()) {
        	// Window of embedded Activity didn't get minimum requested size
        	// or the window is cropped
        	return false;
        }
        return true;
    }
    ...
    /**
     * Added by Franzi
     * Check if the minimum size of the window is met
     * (as requested by the containing Activity, for when that
    ...
    private boolean fullyVisible() {
    	try {
    		...
    		return true; // Then this isn't an Activity anyway
    	}
    }
