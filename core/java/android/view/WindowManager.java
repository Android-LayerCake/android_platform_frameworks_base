...
public interface WindowManager extends ViewManager {
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams
        ...
        @ViewDebug.ExportedProperty(mapping = {
            ...
            @ViewDebug.IntToString(from = TYPE_EMBEDDED_ACTIVITY, to = "TYPE_EMBEDDED_ACTIVITY"),
        ...
        /**
         * Added by Franzi.
         * These are embedded windows. They act like TYPE_APPLICATION_PANEL,
         * except that their frame is not matched to their container.
         */
        public static final int TYPE_EMBEDDED_ACTIVITY = FIRST_SUB_WINDOW+5;
        ...
        /**
         * Added by Franzi, needed to mess around with embedded windows.
         * Future children should be able to find me in WindowManagerService
         * by matching their realParentToken against my selfToken;
         */
        public IBinder realParentToken = null;
        public IBinder selfToken = null;
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            out.writeStrongBinder(selfToken);
            out.writeStrongBinder(realParentToken);
        ...
        public LayoutParams(Parcel in) {
            ...
            selfToken = in.readStrongBinder();
            realParentToken = in.readStrongBinder();
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            if (selfToken == null) {
            	// NOTE: token only copied if the recipient doesn't
                // already have one.
                selfToken = o.selfToken;
            }
            if (realParentToken == null) {
            	// NOTE: token only copied if the recipient doesn't
                // already have one.
                realParentToken = o.realParentToken;
            }
            if (packageName == null) {
