...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
    ...
    /**
     * If set in an Intent passed to {@link Context#startActivity Context.startActivity()},
     * this flag will cause a newly launching Activity to be placed inside the same
     * window as the embedded Activity that called startActivity(). If the parent Activity
     * is not itself embedded, this has no effect.
     * Added by Franzi
     */
    public static final int FLAG_ACTIVITY_EMBEDDED = 0X00002000;
    /**
     ...
     *
     * @deprecated Deprecated/hidden in stock Android, for use in LayerCake.
     */
    @Deprecated
