...
public class ActivityInfo extends ComponentInfo
    ...
    /**
     * Added by Franzi
     * Minimum height requirement if this Activity is to be embedded in 
     * an EmbeddedActivityView. (System will notify user if this isn't met.)
     */
    public int minEmbedHeight;
    ...
    public ActivityInfo(ActivityInfo orig) {
        ...
        minEmbedHeight = orig.minEmbedHeight;
        minEmbedWidth = orig.minEmbedWidth;
        flags = orig.flags;
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(minEmbedHeight);
        dest.writeInt(minEmbedWidth);
        dest.writeInt(flags);
    ...
    private ActivityInfo(Parcel source) {
        ...
        minEmbedHeight = source.readInt();
        minEmbedWidth = source.readInt();
