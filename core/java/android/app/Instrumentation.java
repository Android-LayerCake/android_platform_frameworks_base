...
//      }
     ...
     * Added by Franzi.
     * 
     * Starts an embedded Activity. 
     * Embedded Activities don't return results.
     */
    public void execStartEmbeddedActivity(
    		Context who, IBinder contextThread, IBinder token, Activity target,
            Intent intent, Bundle layoutParams, int id) {
    	IApplicationThread whoThread = (IApplicationThread) contextThread;
    	try {
            intent.setAllowFds(false);
            intent.migrateExtraStreamToClipData();
            int result = ActivityManagerNative.getDefault()
                .startEmbeddedActivity(whoThread, intent,
                        intent.resolveTypeIfNeeded(who.getContentResolver()),
                        token, target != null ? target.mEmbeddedID : null,
                        0, null, null, layoutParams, id);
     ...
     * Added by Franzi.
     * 
     * Refreshes an embedded Activity with new layout params.
     */
    public void execRefreshEmbeddedActivity(
    		Context who, IBinder contextThread, IBinder token, Activity target,
    		int id, Bundle layoutParams) {
    	IApplicationThread whoThread = (IApplicationThread) contextThread;
    	try {
            int result = ActivityManagerNative.getDefault()
                .refreshEmbeddedActivity(whoThread, id,
                        token, target != null ? target.mEmbeddedID : null,
                        0, null, null, layoutParams);
        } catch (RemoteException e) {
        }
    }
     ...
     * Added by Franzi.
     * 
     * Removes an embedded Activity.
     */
    public void execRemoveEmbeddedActivity(
    		Context who, IBinder contextThread, IBinder token, Activity target,
    		int id) {
    	IApplicationThread whoThread = (IApplicationThread) contextThread;
    	try {
            int result = ActivityManagerNative.getDefault()
                .removeEmbeddedActivity(whoThread, id,
                        token, target != null ? target.mEmbeddedID : null,
                        0, null, null);
        } catch (RemoteException e) {
        }
