...
public abstract class ActivityManagerNative extends Binder implements IActivityManager
{
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
        ...
        switch (code) {
        case START_EMBEDDED_ACTIVITY_TRANSACTION:
        {
            ...
            Bundle layoutParams = data.readInt() != 0
                    ? Bundle.CREATOR.createFromParcel(data) : null;
            int id = data.readInt();
            int result = startEmbeddedActivity(app, intent, resolvedType,
                    resultTo, resultWho, startFlags,
                    profileFile, profileFd, layoutParams, id);
            reply.writeNoException();
            reply.writeInt(result);
            return true;
        }
        
        case REFRESH_EMBEDDED_ACTIVITY_TRANSACTION:
        {
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            ...
            Bundle layoutParams = data.readInt() != 0
                    ? Bundle.CREATOR.createFromParcel(data) : null;
            int result = refreshEmbeddedActivity(app, id,
                    resultTo, resultWho, startFlags,
                    profileFile, profileFd, layoutParams);
            reply.writeNoException();
            reply.writeInt(result);
            return true;
        }
        
        case REMOVE_EMBEDDED_ACTIVITY_TRANSACTION:
        {
            data.enforceInterface(IActivityManager.descriptor);
            IBinder b = data.readStrongBinder();
            IApplicationThread app = ApplicationThreadNative.asInterface(b);
            ...
            ParcelFileDescriptor profileFd = data.readInt() != 0
                    ? data.readFileDescriptor() : null;
            int result = removeEmbeddedActivity(app, id,
                    resultTo, resultWho, startFlags,
        ...
        case CHILD_ACTIVITY_DESTROYED_TRANSACTION: {
            data.enforceInterface(IActivityManager.descriptor);
            IBinder containerToken = data.readStrongBinder();
            IBinder childToken = data.readStrongBinder();
            childActivityDestroyed(containerToken, childToken);
            reply.writeNoException();
            return true;
        }
...
class ActivityManagerProxy implements IActivityManager
{
    ...
    public int startEmbeddedActivity(IApplicationThread caller, Intent intent,
            String resolvedType, IBinder resultTo, String resultWho,
            int startFlags, String profileFile,
            ParcelFileDescriptor profileFd, Bundle layoutParams, int id) throws RemoteException {
        ...
        if (layoutParams != null) {
            data.writeInt(1);
            layoutParams.writeToParcel(data, 0);
        } else {
            data.writeInt(0);
        }
        data.writeInt(id);
        mRemote.transact(START_EMBEDDED_ACTIVITY_TRANSACTION, data, reply, 0);
        reply.readException();
    ...
    public int refreshEmbeddedActivity(IApplicationThread caller, int id, 
    		IBinder resultTo, String resultWho,
            int startFlags, String profileFile,
            ParcelFileDescriptor profileFd, Bundle layoutParams) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeStrongBinder(caller != null ? caller.asBinder() : null);
        ...
        mRemote.transact(REFRESH_EMBEDDED_ACTIVITY_TRANSACTION, data, reply, 0);
        reply.readException();
        int result = reply.readInt();
        reply.recycle();
        data.recycle();
    ...
    public int removeEmbeddedActivity(IApplicationThread caller, int id, 
    		IBinder resultTo, String resultWho,
            int startFlags, String profileFile,
            ParcelFileDescriptor profileFd) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeStrongBinder(caller != null ? caller.asBinder() : null);
        ...
        mRemote.transact(REMOVE_EMBEDDED_ACTIVITY_TRANSACTION, data, reply, 0);
        reply.readException();
        int result = reply.readInt();
        reply.recycle();
        data.recycle();
    ...
    public void childActivityDestroyed(IBinder containerToken, IBinder childToken) throws RemoteException
    {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeStrongBinder(containerToken);
        data.writeStrongBinder(childToken);
        mRemote.transact(CHILD_ACTIVITY_DESTROYED_TRANSACTION, data, reply, IBinder.FLAG_ONEWAY);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
