...
public interface IActivityManager extends IInterface {
	public int startEmbeddedActivity(IApplicationThread caller,
            Intent intent, String resolvedType, IBinder resultTo, 
            String resultWho, int flags, String profileFile,
            ParcelFileDescriptor profileFd, Bundle layoutParams, int id) throws RemoteException;
	public int refreshEmbeddedActivity(IApplicationThread caller,
			int id, IBinder resultTo, 
            String resultWho, int flags, String profileFile,
            ParcelFileDescriptor profileFd, Bundle layoutParams) throws RemoteException;
	public int removeEmbeddedActivity(IApplicationThread caller,
			int id, IBinder resultTo, 
            String resultWho, int flags, String profileFile,
    ...
    int START_EMBEDDED_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+160;
    int REFRESH_EMBEDDED_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+161;
    int REMOVE_EMBEDDED_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+162;
    int CHILD_ACTIVITY_DESTROYED_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+163;
}
