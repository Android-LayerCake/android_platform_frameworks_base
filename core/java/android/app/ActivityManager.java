...
public class ActivityManager {
    ...
    /**
     * Result for IActivityManager.refreshEmbeddedActivity: an error where the
     * embedded activity couldn't be found.
     * @hide
     */
    public static final int REFRESH_CHILD_NOT_FOUND = -7;
