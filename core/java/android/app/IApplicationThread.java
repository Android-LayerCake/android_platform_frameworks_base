...
public interface IApplicationThread extends IInterface {
	void scheduleRemoveEmbeddedActivity(IBinder token) throws RemoteException;
	void scheduleRefreshEmbeddedActivity(IBinder token, Bundle layoutParams) throws RemoteException;
	void scheduleLaunchEmbeddedActivity(Intent intent, IBinder token, int ident,
    ...
    int SCHEDULE_LAUNCH_EMBEDDED_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+47;
    int SCHEDULE_REFRESH_EMBEDDED_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+48;
    int SCHEDULE_REMOVE_EMBEDDED_ACTIVITY_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION+49;
}
